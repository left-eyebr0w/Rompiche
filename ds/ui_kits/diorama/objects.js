...
/* ── Couche objets · props placés dans le monde ──────────────────────────────
   Le terrain (Terrain.js) est le substrat STATIQUE baké : sol + relief sur grille.
   ...
   size/position sont en unités-monde (cf. coords.js). C'est délibérément minimal :
...
export function makeObject({ id, materialId, size, position }) {
...
export function makeDefaultObjects() {
  return []
}
